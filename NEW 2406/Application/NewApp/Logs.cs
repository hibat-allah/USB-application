...
namespace NewApp
{
    ...
    {
        private static string connectionString = "Host=192.168.1.133;Port=5432;Username=zflub;Password=M#N@d31N;Database=entreprisebd";
        static string logFilePath = @"C:\Users\ASUS\Documents\LogLogs.txt"; // Update with an appropriate path
